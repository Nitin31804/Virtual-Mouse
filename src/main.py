...
class AIVirtualMouse:
    ...
    def initialize_components(self):
        ...
        try:
            ...
            if calib_data:
                ...
                self.cursor_controller.calib_slope = list(calib_data.values())[0:2] # Simplification, ensure data matches
    ...
    def process_frame(self, frame):
        ...
        self.overlay.draw_active_region(frame, margin_ratio=self.cursor_controller.frame_margin)
    ...
    def run(self):
        ...
        self.running = True
        logging.info("Application started. Press 'q' to quit, 'p' to pause, 'c' to calibrate")
