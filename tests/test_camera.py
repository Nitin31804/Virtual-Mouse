...
class TestCameraManager:
    ...
    def test_successful_open(self, mock_video_capture, camera_manager):
        ...
        # We need to prevent the thread from actually running infinitely during test
        # We can mock the `start` method of Thread to verify it was called without spawning it
